defmodule Sandbox.ModuleVersionManager do
  ...
  def hot_swap_module(sandbox_id, module, new_beam_data, opts \\ []) do
    GenServer.call(__MODULE__, {:hot_swap_module, sandbox_id, module, new_beam_data, opts}, 30_000)
  end
  ...
  defp is_erlang_stdlib_module(module) do
    ...
    String.starts_with?(module_str, ":") or
      module in [
        Enum, String, Process, GenServer, Supervisor,
        Agent, Task, Registry, Logger, Application,
        Code, File, Path, System, IO, Kernel
      ]
  end
