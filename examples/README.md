...
| `snakepit_sandbox_demo/` | Advanced | Runs Snakepit inside a Sandbox and monitors it with Beamlens (mock + live-provider; pooling uses Python gRPC workers, auto-installs deps via uv) |
